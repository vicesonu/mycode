...
def get_ip_data():
    ...
    input_ip2 = input("\nWhat RAM size are you using?")
    input_driver2 = input("What driver are you using?")

    d = {"IP": input_ip, "driver": input_driver,"IP2": input_ip2, "driver2": input_driver}
    return d
...
## mylistdict = [ {"IP": "172.16.2.10", "driver": "arista_eos"}] {"IP": "172.16.2.20", "driver": "arista_eos"} ] {"IP": "172.20.200.26","driver": "victor"}] {"ip": "182.39.2.10", "driver": "hey"}]  
